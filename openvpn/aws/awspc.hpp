...
#ifndef OPENVPN_AWS_AWSPC_H
#define OPENVPN_AWS_AWSPC_H
...
namespace openvpn {
  class AwsPCQuery : public RC<thread_unsafe_refcount>
  {
  public:
    typedef RCPtr<AwsPCQuery> Ptr;
    ...
    AwsPCQuery(WS::ClientSet::Ptr cs_arg,
